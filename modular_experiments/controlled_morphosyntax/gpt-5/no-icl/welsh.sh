...
. ./modular_experiment_outputs_controlled/gpt-5/welsh/metascripts/word_order.sh
. ./modular_experiment_outputs_controlled/gpt-5/welsh/metascripts/morphosyntax_0_0_0.sh

. ./modular_experiment_outputs_controlled/gpt-5/welsh/metascripts/evaluation_0_0.sh
