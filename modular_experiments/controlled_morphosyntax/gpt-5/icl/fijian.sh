...
. ./modular_experiment_outputs_controlled/gpt-5/fijian_icl/metascripts/word_order.sh
. ./modular_experiment_outputs_controlled/gpt-5/fijian_icl/metascripts/morphosyntax_0_0_0.sh

. ./modular_experiment_outputs_controlled/gpt-5/fijian_icl/metascripts/evaluation_0_0.sh
