...
. ./modular_experiment_outputs_controlled/gpt-5-mini/mizo/metascripts/word_order.sh
. ./modular_experiment_outputs_controlled/gpt-5-mini/mizo/metascripts/morphosyntax_0_0_0.sh

. ./modular_experiment_outputs_controlled/gpt-5-mini/mizo/metascripts/evaluation_0_0.sh
