...
. ./modular_experiment_outputs_controlled/gpt-5-mini/arabic/metascripts/word_order.sh
. ./modular_experiment_outputs_controlled/gpt-5-mini/arabic/metascripts/morphosyntax_0_0_0.sh

. ./modular_experiment_outputs_controlled/gpt-5-mini/arabic/metascripts/evaluation_0_0.sh
